...
public class HttpServicesClass {
    ...
    //Recuperacion de respuesta
    public String getResponse(){
        return response;
    }

    //si hay error lo podremos recoger y consultar
    public String getErrorMessage(){
        return message;
    }

    //el codigo de la respuesta
    public int getResponseCode(){
        return responseCode;
    }

    //Llamamos a este constructor para añadir la url de la pagina a enviar los datos
    ...
    //preparamos el metodo get de php
    ...
    //preparamos el metodo post de PHP
    ...
    //convertimos lo que nos ha devuelto en String
